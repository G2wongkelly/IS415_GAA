...
According to the map generated, the proportion of B (non functional points) within the neighborhood of A (functional points) is lower than the global porportion of A, the colocation quotient is therefore low or there are only a few local colocation quotient (LCLQ) with the value of 1 which means there is low colocation between the points.

**Therefore, I will reject the alternative hypothesis and accept the null hypothesis saying that the distribution of functional and non-functional water points are independent from each other.**
